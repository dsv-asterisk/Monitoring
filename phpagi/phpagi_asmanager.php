  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function AGI_AsteriskManager($config=NULL, $optconfig=array())
    {
      ...
      if(!isset($this->config['asmanager']['server'])) $this->config['asmanager']['server'] = '';
      if(!isset($this->config['asmanager']['port'])) $this->config['asmanager']['port'] = '5038';
      if(!isset($this->config['asmanager']['username'])) $this->config['asmanager']['username'] = '';
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = '';
    }
